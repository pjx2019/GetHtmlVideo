...
public class Configurator {
    ...
    public Configurator withIsDebug(boolean isDebug) {
        CONFIGS.put(ConfigKeys.IS_DEBUG, isDebug);
        return this;
    }

    public Configurator withAppId(String appId) {
        CONFIGS.put(ConfigKeys.APP_ID, appId);
        return this;
    }

    public Configurator withAppSecret(String appSecret) {
        CONFIGS.put(ConfigKeys.APP_SECRET, appSecret);
        return this;
    }
